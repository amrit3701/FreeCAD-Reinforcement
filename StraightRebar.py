...
class _StraightRebarTaskPanel:
    def __init__(self, Rebar = None):
        ...
        self.form.image.setPixmap(QtGui.QPixmap(os.path.split(os.path.abspath(__file__))[0] + "/icons/StraightRebarH.svg").scaledToWidth(250))
    ...
    def changeOrientation(self):
        ...
        if orientation == "Horizontal":
            ...
            self.form.image.setPixmap(QtGui.QPixmap(os.path.split(os.path.abspath(__file__))[0] + "/icons/StraightRebarV.svg").scaledToWidth(250))
